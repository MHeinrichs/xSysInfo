...
static const char *default_strings[MSG_COUNT] = {
    ...
    /*MSG_AGNUS_ECS_2MB_PAL*/   "FatAgnus 8375 (ECS)",
    /*MSG_AGNUS_ECS_2MB_NTSC*/  "FatAgnus 8375 (ECS)",
    /*MSG_AGNUS_ECS_B_PAL*/	    "FatAgnus 8372B (ECS)",
    /*MSG_AGNUS_ECS_B_NTSC*/	"FatAgnus 8372B (ECS)",
